...
from rnr_debug_helpers.utils.io_helpers import smart_file_open, RankerRelevanceFileQueryStream

_MOCK_RELEVANCE_FILE = resource_filename('resources.tests', 'mock_relevance_file.csv')
...
_EXPECTED_DOC_IDS = [["doc_id_1", "doc_id_24", "doc_id_7000"], ["doc_id_36", "doc_id_2", "doc_id_3"],
                     ["doc_id_3", "doc_id_2", "doc_id_3"], ["doc_id_36", "doc_id_2", "doc_id_3"], []]
_EXPECTED_LABELS = [[1, 3, 1], [2, 2, 0], [1, 1000, 1], [2, 0, 0], []]
